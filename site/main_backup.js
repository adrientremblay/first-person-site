...
iframe.src="https://www.youtube.com/embed/bpOSxM0rNPM";
...
// --- 3) Quick test hooks to confirm the iframe gets pointer/wheel events ---
iframe.addEventListener('pointerdown', (e) => console.log('iframe pointerdown', e));
iframe.addEventListener('wheel', (e) => {
  console.log('iframe wheel', e.deltaY);
  // do NOT preventDefault — we want the iframe or page inside it to scroll
});
